...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maison Jaipur — Heritage Jewellery House" },
      {
        name: "description",
        content:
          "Handcrafted bridal, diamond and bespoke jewellery from a heritage house in Jaipur, India.",
      },
      { property: "og:site_name", content: "Maison Jaipur" },
